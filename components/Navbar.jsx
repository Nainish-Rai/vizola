...
const Navbar = () => {
  return (
    <nav className="w-full p-5 fixed top-0 flex items-center justify-between max-w-7xl mx-auto">
      ...
      <div className="hidden shadow-md bg-gradient-to-r from-sky-400 to-cyan-300 sm:flex justify-center items-center p-2 px-4 rounded-full text-black font-semibold">
        Get Demo
      </div>
