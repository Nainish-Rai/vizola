...
const Hero = () => {
  return (
    <div className=" snap-center flex h-screen flex-col mt-12 lg:mt-0 lg:flex-row justify-between items-center md:mx-12 mx-5">
      ...
      <motion.div variants={textVariant(0.4)} initial="hidden" whileInView="show"  className="w-[80%] px-5 md:px-0 lg:w-1/3 aspect-square select-none my-1 md:mt-0 cursor-grab">
        {/* <Spline scene="https://prod.spline.design/j-rajp45Ds5skwbh/scene.splinecode" />
         */}
           <Spline scene="https://prod.spline.design/6YhQKUDLsClDF0l7/scene.splinecode" />
      </motion.div>
    </div>
  );
};
