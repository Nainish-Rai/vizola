...
const Solution = () => {
  return (
    <div className=" snap-center my-12 h-screen flex flex-col md:flex-row justify-between  items-center md:mx-12">
      <div className="md:w-2/3 w-full">
        <motion.h1
          variants={textVariant(0.15)}
          initial="hidden"
          whileInView="show"
          className=" text-5xl text-center md:text-left leading-normal font-semibold"
        >
        ...
        <motion.p
          ...
          initial="hidden"
          whileInView="show"
          className=" mt-5 lg:mr-24 text-center text-gray-200  md:text-left"
        >
      ...
      <motion.div
        ...
        initial="hidden"
        whileInView="show"
        className="w-full mt-2 md:mt-0 md:w-1/3 aspect-square select-none"
      >
